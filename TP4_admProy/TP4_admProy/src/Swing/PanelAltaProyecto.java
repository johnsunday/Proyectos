...
/**
 * Definimos el layout para el panel necesario al dar de alta un proyecto. 
 * Cada vez que necesitamos mostrar un panel para el alta de proyectos, directamente llamamos a esta clase.
 * En su contructor, el panel espera un handler, que proviene desde el form. 
 *
 */

public class PanelAltaProyecto extends JPanel{
...
//	private JLabel lblId;
	...
	public PanelAltaProyecto(HandlerProyecto handler) {
		...
		botonAceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				//Integer.parseInt(txtPresupuesto.getText())
					...
					Proyecto p;
					try {
						p = handler.validarProyecto(null, txtTema.getText(),txtPresupuesto.getText() );
					
						try {
							handler.altaProyecto(p);
							handler.mostrarExito("El Proyecto "+ p.getTema() +" fue dado de alta ");
							txtTema.setText("");
